...
/**
  ...
  * @param placement      Placement type of the impression.
  ...
  * @param companionad    list of com.clearafix.openrtb.model.{@link com.clearafix.openrtb.model.Banner Banner} objects if companion ads are available
